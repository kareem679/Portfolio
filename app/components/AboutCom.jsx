  ...
  return (
    <div className=" mx-auto px-4 mb-32">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 place-items-center">
        <div className="bg-amber-50 w-full max-w-[320px] sm:max-w-[340px] md:max-w-[300px] lg:max-w-[400px] h-[500px] lg:h-[600px]  rounded-md p-4" style={{ boxShadow: "4px 8px 20px rgba(94, 234, 212, 0.4)" }}>
